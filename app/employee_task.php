...
WHERE H.user_id = '$user_id' GROUP BY H.taskId");
                ...
                while ($rowM = $queryMain->fetch(PDO::FETCH_ASSOC)) {
                    ...
                    $queryAll = $db->prepare("SELECT COUNT(H.user_task_id) AS allCount FROM user_has_tasks AS H
WHERE H.user_id = '$user_id' AND H.taskId = '" . $rowM['taskId'] . "' ");
                    $queryAll->execute();
                    $rowALL = $queryAll->fetch(PDO::FETCH_ASSOC);
                    $allCount = $rowALL['allCount'];

                    $queryCompleted = $db->prepare("SELECT COUNT(H.user_task_id) AS completedCount FROM user_has_tasks AS H
WHERE H.user_id = '$user_id' AND H.taskId = '" . $rowM['taskId'] . "' AND H.user_task_status ='4'");
                    $queryCompleted->execute();
                    $rowCOM = $queryCompleted->fetch(PDO::FETCH_ASSOC);
                    $completedCount = $rowCOM['completedCount'];

                    $comPercentage = ceil((100/$allCount) * $completedCount);
                    ?>
                        ...
                        <div class="card-body">
                            ...
                            <div class="d-flex flex-wrap align-items-center justify-content-between">
                                <div class="d-flex align-items-center">
                                    <div class="col-md-12">
                                        ...
                                        <div class="progress mb-3">
                                            <div class="progress-bar" role="progressbar" style="width: <?php echo $comPercentage; ?>%;"
                                                 aria-valuenow="<?php echo $comPercentage; ?>" aria-valuemin="0" aria-valuemax="100"><?php echo $comPercentage; ?>%
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="media align-items-center mt-md-0 mt-3">
                                    <a class="btn bg-primary" data-toggle="collapse"
                                       href="#collapseEdit<?php echo $rowM['taskId']; ?>"
                                                ...
                                                <div class="card-body">
                                                    <div class="row">
                                                        <div class="col-lg-2">
                                                            <div class="form-group mb-0">
                                                                <label for="exampleInputText2"
                                                                       class="h5"><?php echo $rowD['activity_name']; ?></label>
                                                            </div>
                                                        </div>
                                                        <div class="col-lg-2">
                                                            <div class="form-group mb-0">
                                                                <label for="exampleInputText3"
                                                                       class="h5"><?php echo $rowD['activity_description']; ?></label>
                                                        ...
                                                        <div class="col-lg-2">
                                                            <div class="form-group mb-0">
                                                                <label for="exampleInputText3"
                                                                       class="h5"><?php echo $rowD['date_start']; ?></label>
                                                        ...
                                                        <div class="col-lg-2">
                                                            <div class="form-group mb-0">
                                                                <label for="exampleInputText3"
                                                                       class="h5"><?php echo $rowD['date_complete']; ?></label>
                                                            ...
                                                            <div class="form-group mb-0">
                                                                <label for="exampleInputText3" class="h5">
                                                                    <?php if ($rowD['user_task_status'] == 0) { ?>
                                                                        <span
                                                                            class="badge badge-light-gray">Pending</span>
                                                                    <?php } ?>
                                                                    ...
                                                                    <?php if ($rowD['user_task_status'] == 2) { ?>
                                                                        <span
                                                                            class="badge bg-gradient-cyan">Working</span>
                                                                    <?php } ?>
                                                        ...
                                                        <div class="col-lg-2">
                                                            <div class="form-group mb-0">
                                                                ...
                                                                <?php if ($rowD['user_task_status'] == 1) { ?>
                                                                    <a class="btn btn-sm bg-gradient-cyan"
                                                                       data-toggle="tooltip" data-placement="top"
                                                                       title=""
